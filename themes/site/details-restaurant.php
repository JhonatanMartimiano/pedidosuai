<?php $v->layout("_theme"); ?>
<?php $v->start("styles"); ?>
<link href="<?= theme("/assets/css/detail-page.css"); ?>" rel="stylesheet">
<?php $v->end("styles"); ?>
<div class="hero_in detail_page background-image" data-background="url(<?= theme("/assets/img/hero_general_2.jpg"); ?>)">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-6">
                        <div class="buttons clearfix">
	                                <span class="magnific-gallery">
	                                    <a href="<?= theme("/assets/img/detail_1.jpg"); ?>" class="btn_hero" title="Photo title"
                                           data-effect="mfp-zoom-in"><i class="icon_image"></i>View photos</a>
	                                    <a href="<?= theme("/assets/img/detail_2.jpg"); ?>" title="Photo title" data-effect="mfp-zoom-in"></a>
	                                    <a href="<?= theme("/assets/img/detail_3.jpg"); ?>" title="Photo title" data-effect="mfp-zoom-in"></a>
	                                </span>
                        ...
                        <table class="table cart-list menu-gallery">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_1.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-1.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_2.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-2.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                                        <h4>2. Fajitas</h4>
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_3.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-3.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_4.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-4.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_1.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-5.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_2.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-6.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_3.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-7.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                                        <h4>7. Beef Taco</h4>
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_4.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-8.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_1.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-9.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_2.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-10.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_1.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-17.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_2.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-18.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                                        <h4>12. Cheesecake</h4>
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_3.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-19.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_4.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-20.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_1.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-15.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
                                        <h4>15. Coca Cola</h4>
                            ...
                            <tr>
                                <td class="d-md-flex align-items-center">
                                    <figure>
                                        <a href="<?= theme("/assets/img/menu_item_large_2.jpg"); ?>" title="Photo title"
                                           data-effect="mfp-zoom-in"><img src="<?= theme("/assets/img/menu-thumb-placeholder.jpg"); ?>"
                                                                          data-src="<?= theme("/assets/img/menu-thumb-16.jpg"); ?>" alt="thumb"
                                                                          class="lazy"></a>
                                    </figure>
                                    <div class="flex-md-column">
            ...
            <section id="section-5">
                ...
                <div id="reviews">
                    <div class="review_card">
                        <div class="row">
                            <div class="col-md-2 user_info">
                                <figure><img src="<?= theme("/assets/img/avatar4.jpg"); ?>" alt=""></figure>
                                <h5>Lukas</h5>
                            </div>
                    ...
                    <div class="review_card">
                        <div class="row">
                            <div class="col-md-2 user_info">
                                <figure><img src="<?= theme("/assets/img/avatar1.jpg"); ?>" alt=""></figure>
                                <h5>Marika</h5>
                            </div>
                            <div class="col-md-10 review_content">
                                <div class="clearfix add_bottom_15">
                        ...
                        <div class="row reply">
                            <div class="col-md-2 user_info">
                                <figure><img src="<?= theme("/assets/img/avatar.jpg"); ?>" alt=""></figure>
                            </div>
                            <div class="col-md-10">
...
<!-- /container -->
<?php $v->start("scripts"); ?>
<script src="<?= theme("/assets/js/sticky_sidebar.min.js"); ?>"></script>
<script src="<?= theme("/assets/js/sticky-kit.min.js"); ?>"></script>
<script src="<?= theme("/assets/js/specific_detail.js"); ?>"></script>
<?php $v->end("scripts"); ?>
