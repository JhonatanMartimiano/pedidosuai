    ...
    <div class="owl-carousel owl-theme categories_carousel">
        <div class="item_version_2">
            <a href="grid-listing-filterscol.html">
                <figure>
                    <span>98</span>
                    <img src="<?= theme("/assets/img/home_cat_placeholder.jpg"); ?>"
                         data-src="<?= theme("/assets/img/home_cat_pizza.jpg"); ?>" alt=""
        ...
        <div class="item_version_2">
            <a href="grid-listing-filterscol.html">
                <figure>
                    <span>87</span>
                    <img src="<?= theme("/assets/img/home_cat_placeholder.jpg"); ?>"
                         data-src="<?= theme("/assets/img/home_cat_sushi.jpg"); ?>" alt=""
                         class="owl-lazy" width="350" height="450">
                    <div class="info">
                        <h3>Japanese</h3>
        ...
        <div class="item_version_2">
            <a href="grid-listing-filterscol.html">
                <figure>
                    <span>55</span>
                    <img src="<?= theme("/assets/img/home_cat_placeholder.jpg"); ?>"
                         data-src="<?= theme("/assets/img/home_cat_hamburgher.jpg"); ?>" alt=""
                         class="owl-lazy" width="350" height="450">
                    <div class="info">
                        <h3>Burghers</h3>
        ...
        <div class="item_version_2">
            <a href="grid-listing-filterscol.html">
                <figure>
                    <span>55</span>
                    <img src="<?= theme("/assets/img/home_cat_placeholder.jpg"); ?>"
                         data-src="<?= theme("/assets/img/home_cat_vegetarian.jpg"); ?>" alt=""
                         class="owl-lazy" width="350" height="450">
                    <div class="info">
                        <h3>Vegetarian</h3>
                        <small>Avg price $40</small>
        ...
        <div class="item_version_2">
            <a href="grid-listing-filterscol.html">
                <figure>
                    <span>65</span>
                    <img src="<?= theme("/assets/img/home_cat_placeholder.jpg"); ?>"
                         data-src="<?= theme("/assets/img/home_cat_bakery.jpg"); ?>" alt=""
                         class="owl-lazy" width="350" height="450">
                    <div class="info">
                        <h3>Bakery</h3>
        ...
        <div class="item_version_2">
            <a href="grid-listing-filterscol.html">
                <figure>
                    <span>25</span>
                    <img src="<?= theme("/assets/img/home_cat_placeholder.jpg"); ?>"
                         data-src="<?= theme("/assets/img/home_cat_chinesse.jpg"); ?>" alt=""
                         class="owl-lazy" width="350" height="450">
                    <div class="info">
                        <h3>Chinese</h3>
                        <small>Avg price $40</small>
        ...
        <div class="item_version_2">
            <a href="grid-listing-filterscol.html">
                <figure>
                    <span>35</span>
                    <img src="<?= theme("/assets/img/home_cat_placeholder.jpg"); ?>"
                         data-src="<?= theme("/assets/img/home_cat_mexican.jpg"); ?>" alt=""
                         class="owl-lazy" width="350" height="450">
                    <div class="info">
                        <h3>Mexican</h3>
...
<div class="bg_gray">
    <div class="container margin_60_40">
                    ...
                    <ul>
                        <li>
                            <a href="detail-restaurant.html">
                                <figure>
                                    <img src="<?= theme("/assets/img/location_list_placeholder.png"); ?>"
                                         data-src="<?= theme("/assets/img/location_list_1.jpg"); ?>"
                        ...
                        <li>
                            <a href="detail-restaurant.html">
                                <figure>
                                    <img src="<?= theme("/assets/img/location_list_placeholder.png"); ?>"
                                         data-src="<?= theme("/assets/img/location_list_2.jpg"); ?>"
                                         alt="" class="lazy" width="350" height="233">
                                </figure>
                        ...
                        <li>
                            <a href="detail-restaurant.html">
                                <figure>
                                    <img src="<?= theme("/assets/img/location_list_placeholder.png"); ?>"
                                         data-src="<?= theme("/assets/img/location_list_3.jpg"); ?>"
                                         alt="" class="lazy" width="350" height="233">
                                </figure>
                    ...
                    <ul>
                        <li>
                            <a href="detail-restaurant.html">
                                <figure>
                                    <img src="<?= theme("/assets/img/location_list_placeholder.png"); ?>"
                                         data-src="<?= theme("/assets/img/location_list_4.jpg"); ?>"
                                         alt="" class="lazy" width="350" height="233">
                                </figure>
                                <div class="score"><strong>9.5</strong></div>
                                <em>Vegetarian</em>
                        ...
                        <li>
                            <a href="detail-restaurant.html">
                                <figure>
                                    <img src="<?= theme("/assets/img/location_list_placeholder.png"); ?>"
                                         data-src="<?= theme("/assets/img/location_list_5.jpg"); ?>"
                                         alt="" class="lazy" width="350" height="233">
                                </figure>
                                <div class="score"><strong>8.0</strong></div>
                                <em>Chinese</em>
                        ...
                        <li>
                            <a href="detail-restaurant.html">
                                <figure>
                                    <img src="<?= theme("/assets/img/location_list_placeholder.png"); ?>"
                                         data-src="<?= theme("/assets/img/location_list_6.jpg"); ?>"
                                         alt="" class="lazy" width="350" height="233">
                                </figure>
        ...
        <!-- /row -->
        <div class="banner lazy" data-bg="url(<?= theme("/assets/img/banner_bg_desktop.jpg"); ?>)">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="box_how">
                            <figure><img src="<?= theme("/assets/img/lazy-placeholder-100-100-white.png"); ?>"
                                         data-src="<?= theme("/assets/img/how_1.svg"); ?>"
                        ...
                        <div class="box_how">
                            <figure><img src="<?= theme("/assets/img/lazy-placeholder-100-100-white.png"); ?>"
                                         data-src="<?= theme("/assets/img/how_2.svg"); ?>"
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="box_how">
                            <figure><img src="<?= theme("/assets/img/lazy-placeholder-100-100-white.png"); ?>"
                                         data-src="<?= theme("/assets/img/how_3.svg"); ?>"
